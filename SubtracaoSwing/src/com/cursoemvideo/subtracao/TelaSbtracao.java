 ...
 * @author JM
 */
public class TelaSbtracao extends javax.swing.JFrame {

    /**
     * Creates new form TelaSbtracao
     */
    public TelaSbtracao() {
        initComponents();
    }
    ...
    private void btnSubtracaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubtracaoActionPerformed
        ...
        int subt = n1 - n2;
        lblSubtracao.setText(Integer.toString(subt));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSbtracao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaSbtracao().setVisible(true);
            }
        });
    }
